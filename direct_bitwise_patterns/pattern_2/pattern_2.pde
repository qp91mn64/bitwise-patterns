 ...
 * Created: 2026-03-01
 * 
 * Modefied from pattern_1 for its structure
 * 
...
void keyPressed() {
  if (key == CODED) {
    ...
    if (key == '1') {
      ...
      String s = String.format("your_output/pattern_2_%s_xOffset_%d_yOffset_%d_s%s.png", bitwiseString, xOffset, yOffset, stamp());  // For distinction a stamp is used
