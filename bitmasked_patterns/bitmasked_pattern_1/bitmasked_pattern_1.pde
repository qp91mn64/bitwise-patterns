...
void keyPressed() {
  if (key == CODED) {
    ...
    if (key == '1') {
      ...
      String s = String.format("your_output/bitmasked_pattern_1_%s_bitmask_%d_xOffset_%d_yOffset_%d_s%s.png", bitwiseString, bitmask, xOffset, yOffset, stamp());  // For distinction a stamp is used
